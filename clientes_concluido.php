...
function buscarClientesConcluido($pdo) {
    $stmt = $pdo->query("SELECT clientes.id AS cliente_id, clientes.cpf_cnpj, clientes.nome, clientes.email, processos.id AS processo_id, processos.numero AS processo_numero, processos.tipo 
                         ...
                         WHERE processos.status = 'Concluído'");
    return $stmt->fetchAll(PDO::FETCH_ASSOC);
}

$clientesConcluido = buscarClientesConcluido($pdo);
?>
...
<head>
    <meta charset="UTF-8">
    <title>Clientes Concluído</title>
...
<div class="container">
    <div class="card p-4">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <?php foreach ($clientesConcluido as $cliente): ?>
                    <tr>
